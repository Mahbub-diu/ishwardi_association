<?php $__env->startSection('content'); ?>
        ...
        <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="slide-bg" data-background="<?php echo e(asset('public/front-end/img/new-home/banner.webp')); ?>">
                ...
                <div class="swiper-slide video-slide" data-swiper-autoplay="">
                    ...
                    <video autoplay muted loop class="swiper-video">
                        <source src="<?php echo e(asset('public/front-end/img/new-home/home-slider-video.mp4')); ?>" type="video/mp4">
                    </video>
                ...
                <div class="news position-relative flex-items-center">
                    ...
                    <div class="scrolling-list mx-5">
                        <ul class='flex-items-center py-2 mb-0'>
                            <?php $__currentLoopData = $singleUpdate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sUpdate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class='pr-8'>
                                    <a class="news-link"
                                        href="<?php echo e(url('news-event-details/' . $sUpdate->id)); ?>"><?php echo e($sUpdate->title); ?></a>
                                </li>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6  col-xl-6">
                    <div class="img-box1">
                        <img class="w-100"
                            src="<?php echo e(asset('storage/app/public/about-info-landing-pages/' . $aboutLandingData[0]['feature_image'])); ?>"
                            alt="">
                        <?php if($serviceName == 'Institute of Professional Training & Management (IPTM)'): ?>
                            <a href="https://sqccertification.com/cert/Verify" class="counter-box text-center"
                                target="_blank">
                                <img class="" style="" src="<?php echo e(asset('public/front-end/img/iso-logo.png')); ?>"
                                    alt="">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6  col-xl-6 hero-content">
                    <div class="mb-25 mb-xl-5">
                        <h3 class="h3" style="color:#f89939"><?php echo e(!empty($serviceName) ? $serviceName : ''); ?></h3>
                    </div>
                    <p class="mt-n2 mb-35">
                        <?php
                        ...
                        ?>
                    <p>
                        <?php echo e(!empty($aboutTextPara1) ? $aboutTextPara1 : ''); ?>


                        <?php if(!empty($aboutTextPara2)): ?>
                            <br /><br />

                            <?php echo e($aboutTextPara2); ?>

                        <?php endif; ?>

                        <?php if(!empty($aboutTextPara3)): ?>
                            <br /><br />

                            <?php echo e($aboutTextPara3); ?>
                    ...
                    <?php if(!empty($aboutLandingDataBulletPoint)): ?>
                        <!--<div class="checklist mb-45">
                                                                                                                                    <ul>
                                                                                                                                        <?php if(!empty($aboutLandingDataBulletPoint[0])): ?>
    <li><?php echo e($aboutLandingDataBulletPoint[0]); ?></li>
    <?php endif; ?>

                                                                                                                                        <?php if(!empty($aboutLandingDataBulletPoint[1])): ?>
    <li><?php echo e($aboutLandingDataBulletPoint[1]); ?></li>
    <?php endif; ?>

                                                                                                                                        <?php if(!empty($aboutLandingDataBulletPoint[2])): ?>
    <li><?php echo e($aboutLandingDataBulletPoint[2]); ?></li>
    <?php endif; ?>

                                                                                                                                        <?php if(!empty($aboutLandingDataBulletPoint[3])): ?>
    <li><?php echo e($aboutLandingDataBulletPoint[3]); ?></li>
    <?php endif; ?>
                                                                                                                                    </ul>
                                                                                                                                </div>-->
                    <?php endif; ?>
        ...
        <div class="shape-mockup" data-bottom="-9.5%" data-right="0">
            <img src="<?php echo e(asset('public/front-end/img/shape/line_1.png')); ?>" alt="">
        </div>
    </div>


    <?php if($serviceName == 'Institute of Professional Training & Management (IPTM)' || $totalServiceCoverArea > 0): ?>
        <div class="space-bottom practice-area-main" data-bg-src="<?php echo e(asset('public/front-end/img/bg/why_bg_1.png')); ?>">
            <div class="container">
                                ...
                                <div class="checklist mb-30">
                                    ...
                                    <div class="" id="results-practice-area" style="padding:5px;">
                                        ...
                                        <div class="ajax-loading-service-area" style="text-align: center;">
                                            <img src="<?php echo e(asset('public/front-end/img/loader.gif')); ?>" width="70" />
                                        </div>
                            ...
                            <div class="custom-tabs four-tabs">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <?php if(!empty($commonData['service_list'])): ?>
                                        <?php $__currentLoopData = $commonData['service_list']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="box<?php echo e($service['id']); ?>"
                                                    onclick="findPracticeAreaBesedOnServices(<?php echo e($service['id']); ?>)">

                                                    <div class="card">
                                                        <img src="<?php echo e(asset('storage/app/public/services/' . $service['icon'])); ?>"
                        ...
                        <?php else: ?>
                            <div class="custom-tabs six-tabs ">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <?php $__currentLoopData = $serviceCoverArea; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serAreaName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $areaIcon = !empty($serviceCoverAreaList[$serAreaName['id']]['area_icon']) ? $serviceCoverAreaList[$serAreaName['id']]['area_icon'] : ''; ?>

                                        <li class="nav-item" role="presentation" style="margin-bottom:25px">
                                            <button class="nav-link active-custom"
                                                id="box<?php echo e(!empty($serAreaName['id']) ? $serAreaName['id'] : ''); ?>"
                                                onclick="practiceServiceTab(<?php echo e(!empty($serAreaName['id']) ? $serAreaName['id'] : 0); ?>,1)">
                                                <div class="feature-card-wrap">
                                                    <div class="feature-card">
                                                        <div class="feature-card_icon"><img
                                                                src="<?php echo e(asset('storage/app/public/service-cover-areas/' . $areaIcon)); ?>"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <?php if($totalOngoingActivities > 0): ?>
                        ...
                        <div class="right-loader">
                            ...
                            <span id="page-counting-text-ongoing">
                                <span style="font-size:12px;float:left">Showing <span
                                        ...
                                        id="total-data-ongoing"><?php echo e($totalOngoingActivities); ?></span> results </span>
                            </span>
    ...
    <section style="background-color: #BD5E29  !important;line-height:0 !important" class="bg-theme home-counter-main"
        data-bg-src="<?php echo e(asset('public/front-end/img/bg/bg_overlay_2.png')); ?>">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="counter-flex">
                        ...
                        <div class="counter-card-wrap">
                            <div class="counter-card">
                                <h2 class="counter-card_number"><span class="counter-number"
                                        style="font-size:35px"><?php echo e($totalCompletedProject + $totalOngoingActivities); ?></span>
                                </h2>
                        ...
                        <div class="counter-card-wrap">
                            <div class="counter-card">
                                <h2 class="counter-card_number"><span class="counter-number"
                                        style="font-size:35px"><?php echo e($totalCompletedProject); ?></span></h2>
                        ...
                        <div class="counter-card-wrap">
                            <div class="counter-card">
                                <h2 class="counter-card_number"><span class="counter-number"
                                        style="font-size:35px"><?php echo e($totalOngoingActivities); ?></span>
                                </h2>
                        ...
                        <div class="counter-card-wrap">
                            <div class="counter-card">
                                <h2 class="counter-card_number"><span class="counter-number"
                                        style="font-size:35px"><?php echo e($totalourClient); ?></span></h2>
                        ...
                        <div class="counter-card-wrap">
                            <div class="counter-card">
                                <h2 class="counter-card_number"><span class="counter-number"
                                        style="font-size:35px"><?php echo e($totalourParticipates); ?></span></h2>
    ...
    <?php if($totalCompletedProject > 0): ?>
                        ...
                        <div class="right-loader">
                            ...
                            <span id="page-counting-text-completed">
                                <span style="font-size:12px;float:left">Showing <span
                                        ...
                                        id="total-data-completed"><?php echo e($totalCompletedProject); ?></span> results </span>
                            </span>
    ...
    <?php if($totalSingle > 0): ?>
        
    <?php endif; ?>

    <section class="space home-clients-main" data-bg-src="<?php echo e(asset('public/front-end/img/bg/clients.jpg')); ?>">
        <div class="container">
            <div class="title-area text-center">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="team-grid">
                                <div class="team-info">
                                    ...
                                    <img src="<?php echo e(asset('storage/app/public/client_logo/' . $client->client_logo)); ?>"
                                        alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
            ...
            <?php if($totalourClient > 6): ?>
                <div class="row">
                    <div class="col-12">
                        <div class="common-see-all">
                            <a href="<?php echo e(url('our-client')); ?>" class="as-btn">see all clients</a>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
        ...
        <section class="overflow-hidden bg-white space appreciations-slider-main">
            <div class="container">
                ...
                <div class="row appreciations-slider">
                    ...
                    <?php $__currentLoopData = $appreciations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-6">
                            <div class="testi-box">

                                <div class="testi-box_content">
                                    <div class="testi-box_img"><img
                                            src="<?php echo e(asset('storage/app/public/appreciations/' . $ap->photo)); ?>"
                                            alt="">
                                    </div>
                                    <p class="testi-box_text"><?php echo e($ap->details); ?></p>
                                </div>

                                <div class="testi-box_bottom">
                                    <div>
                                        <h3 class="testi-box_name"><?php echo e($ap->name); ?></h3>
                                        <span class="testi-box_desig"><?php echo e($ap->designation); ?></span>
                                        <span class="institute"><?php echo e($ap->company_name); ?></span>
                                    </div>
    ...
    <div data-pos-for=".footer-wrapper" data-sec-pos="bottom-half" style="margin-bottom: -50px;">
        <div class="container">
            <div class="susbcribe-bg background-image"
                data-bg-src="<?php echo e(asset('public/front-end/img/bg/subscribe_bg_1.jpg')); ?>">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 text-center">
                        <a href="<?php echo e(url('contact')); ?>" class="as-btn">contact us<i
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        var site_route_name = "<?php echo e(Request::path()); ?>";

        if (site_route_name == '/' || site_route_name == 'dev') {
            //alert('response');
            // start practice/service tab
            var defaultServiceId =
                "<?php echo e(!empty($commonData['service_list'][0]['id']) ? $commonData['service_list'][0]['id'] : 1); ?>";
        ...
        //var defaultLastOngoingId = "<?php echo e(!empty($commonData['service_list'][0]['id']) ? $commonData['service_list'][0]['id'] : 1); ?>";
...
<?php echo $__env->make('layouts.app-frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ishwardi_association\resources\views/front-end/welcome.blade.php ENDPATH**/ ?>