...
@section('content')
					<div class="page-wrapper">
						<div class="content">
								...
								<div	 class="page-header">
									<div class="row">
										<div class="col-sm-12">
											...
											<ul class="breadcrumb">
												<li class="breadcrumb-item"><a href="{{ url('contact-us') }}">Contact Us</a></li>
							...
							<div class="card">
								<div class="card-body">
									{!! Form::model($contactUs, ['method' => 'PATCH', 'enctype' => 'multipart/form-data', 'route' => ['contact-us.update', $contactUs->id]]) !!}
