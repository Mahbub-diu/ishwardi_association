						...
						<div class="content">
							<div class="page-header">
								<div	 class="page-header">
									<div class="row">
										<div class="col-sm-12">
											<h3 class="page-title">Add New Featured Service</h3>
											<ul class="breadcrumb">
												<li class="breadcrumb-item"><a href="{{ url('galleries') }}">Featured Services</a></li>
												<li class="breadcrumb-item active">Add Featured Service</li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="card">
								<div class="card-body">
									{!! Form::open(array('route' => 'service-cover-areas.store', 'method'=>'POST',  'enctype' => 'multipart/form-data' )) !!}
										@php 
											$service_id = '';
											$area_name = '';
											$area_icon = '';
									...
									<div class="row">
										...
										<div class="col-lg-6 col-sm-6 col-12">
											<div class="form-group">
												...
												{!! Form::select('parent_id', ['0'=>'Select One']+$parentList,[], array('id' => 'service', 'class' => 'form-control'.$service_id,  'tabindex' => '-1', 'aria-hidden' => 'true', 'single' => 'single')) !!} 
										...
										<div class="col-lg-6 col-sm-6 col-12">
											<div class="form-group">
												...
												{!! Form::textarea('short_description', null, array('placeholder' => 'Enter short description','class' => 'form-control '.$short_description)) !!}
