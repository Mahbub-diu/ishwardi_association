						...
						<div class="content">
							<div class="page-header">
								<div	 class="page-header">
									<div class="row">
										<div class="col-sm-12">
											<h3 class="page-title">Edit About Text Info</h3>
											<ul class="breadcrumb">
												...
												<li class="breadcrumb-item active">Edit Text Info</li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="card">
								<div class="card-body">
									{!! Form::model($aboutInfo, ['method' => 'PATCH', 'enctype' => 'multipart/form-data', 'route' => ['about-infos.update', $aboutInfo->id]]) !!}
										...
										@error('organogram')
										  @php $organogram = 'is-invalid border-red'; @endphp
										@enderror
									...
									<div class="row">
										...
										<div class="col-lg-6 col-sm-6 col-6">
											<div class="form-group">
												...
												<img id="previewImg1" src="{{ asset( !empty($aboutInfo->mission_icon) ? 'storage/app/public/about-us/'.$aboutInfo->mission_icon : '' ) }}" alt="" width="100">
										...
										<div class="col-lg-6 col-sm-6 col-6">
											<div class="form-group">
												...
												<img id="previewImg2" src="{{ asset( !empty($aboutInfo->vision_icon) ? 'storage/app/public/about-us/'.$aboutInfo->vision_icon : '' ) }}" alt="" width="100">
										...
										<div class="col-lg-6 col-sm-6 col-6">
											<div class="form-group">
												<label>Value & Risk Management  Icon</label>
												...
												<img id="previewImg3" src="{{ asset( !empty($aboutInfo->value_risk_icon) ? 'storage/app/public/about-us/'.$aboutInfo->value_risk_icon : '' ) }}" alt="" width="100">
										...
										<div class="col-lg-6 col-sm-6 col-6">
											<div class="form-group">
												<label>Organogram  Icon</label>
												{!! Form::file('organogram', array('onchange' => 'previewFile4(this)', 'id' => 'image4', 'class' => 'form-control '.$organogram)) !!}
												...
												<img id="previewImg4" src="{{ asset( !empty($aboutInfo->organogram) ? 'storage/app/public/about-us/'.$aboutInfo->organogram : '' ) }}" alt="" width="100">
												
												@if( !empty($aboutInfo->organogram) )
												{{ Form::checkbox('organogram_remove_image', 1, false, array('class' => '')) }}
													Remove Image
												@endif
										...
										{{--<div class="col-lg-6 col-sm-6 col-6">
											<div class="form-group">
												...
												<img id="previewImg4" src="{{ asset( !empty($aboutInfo->value_risk_spinner_icon) ? 'storage/app/public/about-us/'.$aboutInfo->value_risk_spinner_icon : '' ) }}" alt="" width="100">
										...
										<div class="col-lg-6 col-sm-6 col-12">
											<div class="form-group">
												<label>Total District Covered <span style="color:red"> *</span></label>
												{!! Form::text('district_covered', null, array('placeholder' => '', 'id' => '', 'class' => 'form-control '.$district_covered)) !!}
												
												@error('district_covered')
													<span class="invalid-feedback" style="display:block">
														{{ $message }}
													</span>
												@enderror
										...
										<div class="col-lg-6 col-sm-6 col-12">
											<div class="form-group">
												<label>Total Country Covered <span style="color:red"> *</span></label>
												{!! Form::text('country_covered', null, array('placeholder' => '', 'id' => '', 'class' => 'form-control '.$country_covered)) !!}
												
												@error('country_covered')
													<span class="invalid-feedback" style="display:block">
														{{ $message }}
													</span>
												@enderror
										...
										<div class="col-lg-6 col-sm-6 col-12">
											<div class="form-group">
												<label>Resource Pool <span style="color:red"> *</span></label>
												{!! Form::text('resource_pool', null, array('placeholder' => '', 'id' => 'image3', 'class' => 'form-control '.$resource_pool)) !!}
										...
										<div class="col-lg-12 col-sm-12 col-12">
											<div class="form-group">
												...
												{!! Form::textarea('value_risk_policy', null, array('placeholder' => 'Enter client name','class' => 'form-control '.$value_risk_policy)) !!}
												@error('value_risk_policy')
													<span class="invalid-feedback">
														{{ $message }}
													</span>
										...
										<div class="col-lg-12">
											...
											<a href="{{ url('about-infos') }}" class="btn btn-cancel">Cancel</a>
										</div>
									</div>
