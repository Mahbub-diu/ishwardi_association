					...
					<div class="page-wrapper">
							<div class="content">
								<div class="page-header">
									...
									@can('user-create')
									<div class="page-btn">
										<a href="{{ url('users/create') }}" class="btn btn-added"><img src="{{ asset('public/mine/assets/img/icons/plus.svg') }}" alt="img" class="me-1">Add New User</a>
									</div>
									@endcan
													...
													<div class="col-lg-12 col-sm-12">
														<div class="row">
															...
															<div class="col-lg-1 col-sm-6 col-12">
																<div class="form-group">
																	<a id="search_btn" href="{{ url('users/') }}" class="btn btn-filters ms-auto"><img src="{{ asset('public/mine/assets/img/icons/search-whites.svg') }}" alt="img"></a>
																</div>
															</div>
										...
										<div class="table-responsive">
											<table class="table ">
												...
												<tbody  class="" id="pagination_data">
													...
													@include("backend.users.index-pagination",["data"=>$data])
