									...
									<div class="row">
										...
										<div class="col-lg-6">
											<div class="form-group">
												<label>Role</label>
												<div class="pass-group"> 
												{!! Form::select('roles', [''=>'Select One']+$roles,$userRoleKey, array('id' => 'role', 'class' => 'form-control form-small select select2-hidden-accessible '.$roleError,  'tabindex' => '-1', 'aria-hidden' => 'true', 'single' => 'single')) !!} 
										...
										{{--<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="pass-group"> 
												{!! Form::select('set_permission[]', [''=>'Select Specefic Permission']+$permission,$currentPermisssionReArrange, array('id' => '', 'class' => 'form-control form-small select select2-hidden-accessible set-permission '.$set_permission,  'tabindex' => '-1', 'aria-hidden' => 'true', 'multiple' => 'multiple')) !!} 
																...
																<td align="left">
																	...
																	@foreach($value as $keySub => $valueSub )
																		...
																		<label style="margin:5px">
																			...
																			{{ Form::checkbox('set_permission[]', $keySub, in_array($keySub, $currentPermisssionReArrange) ? true : false, array('class' => 'name')) }}
