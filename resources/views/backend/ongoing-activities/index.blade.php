							...
							<div class="content">
								<div class="page-header">
									<div class="page-title">
										<h4>Ongoing Activity List</h4>
										<h6>Manage Ongoing Activities</h6>
									</div>
									@if( $currentRoleName == 'Data Creator' ||  $currentRoleName == 'System Admin' )
											
										@can('ongoing-activities-create')
										<div class="page-btn">
											<a href="{{ url('ongoing-activities/create') }}" class="btn btn-added"><img src="{{ asset('public/mine/assets/img/icons/plus.svg') }}" alt="img" class="me-1">Add New Ongoing Activity</a>
										</div>
										@endcan
									...
									<div class="card-body">
										...
										<div class="table-top">
											...
											<ul class="nav nav-tabs">
											  <li class="nav-item">
												<a class="nav-link {{ app('request')->input('old_data') == 0 ? 'active' : '' }}" aria-current="page" id="old_data" data-value="0" data-bs-toggle="tab" href="{{ url('ongoing-activities')}}">{{ $tabName1 }}</a>
											  </li>
											  <li class="nav-item">
												<a class="nav-link {{ app('request')->input('old_data') == 1 ? 'active' : '' }}" id="old_data"  data-value="1" data-bs-toggle="tab"  href="{{ url('ongoing-activities')}}">{{ $tabName2 }}</a>
											  </li>
											</ul>
													...
													<div class="col-lg-12 col-sm-12">
														<div class="row">
															...
															<div class="col-lg-1 col-sm-6 col-12">
																<div class="form-group">
																	<label> &nbsp; </label>
																	<a id="search_btn" href="{{ url('ongoing-activities/') }}" class="btn btn-filters ms-auto"><img src="{{ asset('public/mine/assets/img/icons/search-whites.svg') }}" alt="img"></a>
																</div>
															</div>
										...
										<div class="table-responsive">
											<table class="table">
												...
												<tbody id="pagination_data">
													...
													@include("backend.ongoing-activities.index-pagination",["data"=>$data])
