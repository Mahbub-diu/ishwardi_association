                        ...
                        <div class="widget footer-widget style2">
                            <div class="as-widget-about">
                                ...
                                <div class="as-social d-none">
									 ...
									 @if (!empty($commonData['contant_info'][0]['facebook']))
										<a href="{{ $commonData['contant_info'][0]['facebook'] }}" target="_blank"><i class="fab fa-facebook-f"></i></a>
									 @endif
									 
									 @if (!empty($commonData['contant_info'][0]['linkedin']))
										<a href="{{ $commonData['contant_info'][0]['linkedin'] }}" target="_blank"><i class="fab fa-twitter"></i></a> 
									 @endif
									 
									  @if (!empty($commonData['contant_info'][0]['twiter']))
										<a href="{{ $commonData['contant_info'][0]['twiter'] }}" target="_blank"><i class="fab fa-linkedin-in"></i></a> 
									 @endif
									 
									@if (!empty($commonData['contant_info'][0]['youtube']))
										<a  href="{{ $commonData['contant_info'][0]['youtube'] }}" target="_blank"><i class="fab fa-youtube"></i></a>
									@endif
								</div>
                            </div>
                        </div>
