...
<div class="as-hero-wrapper hero-3 {{ !empty($serviceName != 'Institute of Professional Training & Management (IPTM)' ) ? 'slider-reverse-main' : '' }}">
    ...
    <div class="hero-shape shape5">
        <img src="{{ asset('public/front-end/img/hero/IPTMlogo.svg') }}" alt="">
    </div>
                ...
                <div class="news position-relative flex-items-center">
                    ...
                    <div class="scrolling-list mx-5" >
				        <ul class='flex-items-center py-2 mb-0'>
					        @foreach($singleUpdate as $sUpdate)
					        <li class='pr-8'>
						        <a class="news-link" href="{{ url('news-event-details/'.$sUpdate->id) }}">{{ $sUpdate->title }}</a>
					        </li> 
					        @endforeach
				        </ul>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6  col-xl-6">
                    <div class="img-box1">
                        <img class="w-100"
                            ...
                            alt="">
                        @if( $serviceName == 'Institute of Professional Training & Management (IPTM)' )
						<a href="https://sqccertification.com/cert/Verify" class="counter-box text-center" target="_blank">
                     ...
                     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 order-lg-2 order-1">
                        ...
                        <div class="right-loader">
                            ...
                            <span id="page-counting-text-ongoing">
                                <span style="font-size:12px;float:left" >Showing <span id="start-pagination-ongoing">1</span> to <span id="end-pagination-ongoing"></span> of <span id="total-data-ongoing">{{ $totalOngoingActivities  }}</span> results </span>
                            </span>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 order-lg-2 order-1">
						...
						<div class="right-loader">
							...
							<span id="page-counting-text-completed">
								<span style="font-size:12px;float:left" >Showing <span id="start-pagination-completed">1</span> to <span id="end-pagination-completed"></span> of <span id="total-data-completed">{{ $totalCompletedProject  }}</span>  results </span>
							</span>
            ...
            $.ajax({
                ...
                .done(function(data) {
					...
					if (data.total_count > paginateLimitValueCompleted) {
						...
						$('#end-pagination-completed').html(((page_com-1)*paginateLimitValueCompleted)+data.info.length);
