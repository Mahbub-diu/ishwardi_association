                    ...
                    <div class="col-auto d-none d-lg-block">
                        <div class="header-links">
                            <ul>
                                ...
                                <li>{{--<i class="fal fa-clock"></i>--}}{{ !empty($commonData['contant_info'][0]['office_hour']) ? $commonData['contant_info'][0]['office_hour'] : '' }}
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu sub-menu">
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{ url('about-us-f#start') }}">About IPTM</a>
                                </li>
                                <li>
                                ...
                                @if (!empty($commonData['service_list']))
                                    @foreach ($commonData['service_list'] as $sName)
                                        <li>
											...
											<a class="dropdown-item" href="{{ url($sName['route']) }}"><img src="{{ asset('storage/app/public/services/' . $sName['icon']) }}" width="14" alt="">
												{{ $sName['name'] }}
											</a>
                                        </li>
                                    @endforeach
                                    ...
                                    <ul class="dropdown-menu dropdown-submenu">
                                        ...
                                        @if (!empty($commonData['service_list']))
                                            @foreach ($commonData['service_list'] as $sName)
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ url('completed-project') . '/' . $sName['id'] }}">
														<img src="{{ asset('storage/app/public/services/' . $sName['icon']) }}" width="14" alt="">
														{{ $sName['name'] }}
													</a>
                                                </li>
                                            @endforeach
                                    ...
                                    <ul class="dropdown-menu dropdown-submenu">
                                        ...
                                        @if (!empty($commonData['service_list']))
                                            @foreach ($commonData['service_list'] as $sName)
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ url('ongoing-project') . '/' . $sName['id'] }}">
														<img src="{{ asset('storage/app/public/services/' . $sName['icon']) }}" width="14" alt=""> {{ $sName['name'] }}
													</a>
                                                </li>
                                            @endforeach
                                        @endif
						...
						<li class="nav-item dropdown">
                            <a class="nav-link " href="{{ url('news-event') }}" >
                                News & Events
                            </a>
                        </li>
