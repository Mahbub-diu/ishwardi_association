									...
									<div class="row">
										<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
											<div class="single-image">
												...
												<img class="" src="{{ asset('storage/app/public/single-updates/'.$dataDetails->feature_image) }}"
										...
										<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 ps-0">
											...
											<div class="triple-image">
												<img class="" src="{{ asset('storage/app/public/single-updates/'.$otherImages[0]) }}"
											...
											<div class="triple-image">
												<img class="" src="{{ asset('storage/app/public/single-updates/'.$otherImages[1]) }}"
													class="img-fluid w-100" alt="" style="width:280px;height:188px">
											</div>
											@endif
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <tbody>
									...
									@if( !empty( $dataDetails->news_event_status) )
                                    <tr>
                                        <td>Type</td>
                                        <td  style="margin:0;padding:0">:</td>
                                        <td>{{ !empty( $dataDetails->news_event_status == 1) ? 'Event' : '---' }} </td>
                                    </tr>
									@endif
