	...
	@if (!empty($data))
		...
		<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
			<div class="consultancy">
			 <button style="border:none;border-radius:9px"><img data-original="{{ asset('storage/app/public/'.$imageFolderName.'/' . $imageName[0]) }}" src="{{ asset('storage/app/public/'.$imageFolderName.'/' . $imageName[0]) }}" alt="{{ $titleName  }}"> </button>
