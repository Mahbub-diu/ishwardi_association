...
<div class="as-hero-wrapper hero-3 {{ !empty($serviceName != 'Institute of Professional Training & Management (IPTM)' ) ? 'slider-reverse-main' : '' }}">
                            ...
                            <li class="nav-item">
                                <div class="tree-box">
                                    ...
                                    <div class="tree-list">
                                        ...
                                        <h2 class="counter-number">
                                            <span class="counter"  > {{ ($totalProjectServWise[1]+$totalProjectServWise[2]+$totalProjectServWise[3]+$totalProjectServWise[4])  }} +</span>
                                        </h2>
										...
										@foreach($commonData['service_list']  as  $key => $sName )
											...
											<li>
												...
												<div class="child-list">
													{{ $sName['name'] }} ({{ !empty($totalProjectServWise[$key+1]) ? $totalProjectServWise[$key+1] : 0 }})
												</div>
											</li>
										@endforeach
									@endif
                            ...
                            <li class="nav-item">
                                <div class="tree-box">
                                    ...
                                    <div class="tree-list">
                                        ...
                                        <h2 class="counter-number">
                                            <span class="counter"  > {{  !empty($aboutOtherInfo['district_covered']) ? $aboutOtherInfo['district_covered'] : ''  }} +</span>
                                        </h2>
                            ...
                            <li class="nav-item">
                                <div class="tree-box">
                                    ...
                                    <div class="tree-list">
                                        ...
                                        <h2 class="counter-number">
                                            <span class="count	er"  > {{  !empty($aboutOtherInfo['country_covered']) ? $aboutOtherInfo['country_covered'] : ''  }} +</span>
                                        </h2>
						    ...
						    <li class="nav-item">
                                <div class="tree-box">
                                    ...
                                    <div class="tree-list">
                                        ...
                                        <h2 class="counter-number">
                                            <span class="counter"> {{  !empty($aboutOtherInfo['resource_pool']) ? $aboutOtherInfo['resource_pool'] : ''  }} +</span>
                                        </h2>
    ...
    <div class="hero-shape shape1">
		@if( $serviceName == 'Institute of Professional Training & Management (IPTM)' )
			...
			<img src="{{ asset('public/front-end/img/hero/shape_3_1.png') }}" alt="">
		@else
			<img src="{{ asset('public/front-end/img/rotatebg.png') }}" alt="">
    ...
    <div class="hero-shape shape2">
		<img src="{{ asset('public/front-end/img/hero/shape_3_2.png') }}" alt="">
	</div>
	
    <div class="hero-shape shape3">
		<img src="{{ asset('public/front-end/img/hero/shape_3_3.png') }}" alt="">
	</div>
	
    {{-- <div class="hero-shape shape4"><img src="{{ asset('public/front-end/img/hero/shape_3_4.png') }}" alt=""></div> --}}

    <div class="hero-shape shape5">
        <img src="{{ asset('public/front-end/img/hero/IPTMlogo.png') }}" alt="">
    </div>

    <div class="hero-shape shape6"><img src="{{ asset('public/front-end/img/hero/shape_3_6.png') }}" alt=""></div>
    <div class="hero-shape shape7"><img src="{{ asset('public/front-end/img/hero/shape_3_1.png') }}" alt=""></div>
    </div>
						...
						<div class="moving-flex">
							...
							<div class="tickerwrapper">
								<ul class='list'>
									...
									<li class='listitem'>
										<a href="{{ url('news-event-details/'.$sUpdate->id) }}">{{ $sUpdate->title }}</a>
									</li>
									@endforeach
								</ul>
							</div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6  col-xl-6">
                    <div class="img-box1">
                        <img class="w-100"
                            ...
                            alt="">
                        @if( $serviceName == 'Institute of Professional Training & Management (IPTM)' )
						<a href="https://www.iso.org/home.html" class="counter-box text-center" target="_blank">
                    ...
                    <div class="tab-content" id="myTabContent">
						...
						<div class="tab-pane fade show active" id="" >
                            ...
                            <div class="nextprev-button-sets" style="margin-top: -25px;">
								<span style="font-size:12px;float:left" >Showing <span id="start-pagination">1</span> to <span id="end-pagination">8</span> of <span id="total-data">55</span> results </span>
										...
										<div class="feature-card-wrap">
											<div class="feature-card">
												<div class="feature-card_icon"><img
														src="{{ asset('storage/app/public/service-cover-areas/'.$areaIcon) }}" alt="">
												</div>
											</div>
										</div>
									</button>
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						...
						<div class="right-loader">
							...
							<span id="page-counting-text-ongoing">
								<span style="font-size:12px;float:left" >Showing <span id="start-pagination-ongoing">1</span> to <span id="end-pagination-ongoing"></span> of <span id="total-data-ongoing"></span> results </span>
							</span>
                    ...
                    <div class="counter-flex">
						...
						<div class="counter-card-wrap">
                            <div class="counter-card">
                                <h2 class="counter-card_number"><span class="counter-number" style="font-size:35px">{{ $totalCompletedProject + $totalOngoingActivities }}</span></h2>
                        ...
                        <div class="counter-card-wrap">
                            <div class="counter-card">
                                <h2 class="counter-card_number"><span class="counter-number" style="font-size:35px">{{ $totalCompletedProject }}</span></h2>
                        ...
                        <div class="counter-card-wrap">
                            <div class="counter-card">
                                <h2 class="counter-card_number"><span
                                        class="counter-number" style="font-size:35px">{{ $totalOngoingActivities }}</span>
                                </h2>
                        ...
                        <div class="counter-card-wrap">
                            <div class="counter-card">
                                <h2 class="counter-card_number"><span
                                        class="counter-number" style="font-size:35px">{{ $totalourClient }}</span></h2>
						 ...
						 <div class="counter-card-wrap">
                            <div class="counter-card">
                                <h2 class="counter-card_number"><span
                                        class="counter-number" style="font-size:35px">{{ $totalourParticipates }}</span></h2>
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						...
						<div class="right-loader">
							...
							<span id="page-counting-text-completed">
								<span style="font-size:12px;float:left" >Showing <span id="start-pagination-completed">1</span> to <span id="end-pagination-completed"></span> of <span id="total-data-completed"></span> results </span>
							</span>
						...
						<div class="testi-box">
							...
							<div class="testi-box_content">
								<div class="testi-box_img"><img
										src="{{ asset('storage/app/public/appreciations/'.$ap->photo) }}" alt="">
								</div>
                ...
                .done(function(data) {
					...
					if (data.total_count > paginateLimitValue+1) {
						...
						if( page == 1){
							...
							var startPagi = (page*paginateLimitValue);
							var startPagi = (startPagi-paginateLimitValue)+1;
							
							$('#start-pagination-ongoing').html(startPagi);
						}
						$('#end-pagination-ongoing').html(((page-1)*paginateLimitValue)+data.info.length);
                ...
                .done(function(data) {
					...
					if (data.total_count > paginateLimitValue+1) {
						...
						if( page_com == 1){
							...
							var startPagi = (page_com*paginateLimitValue);
							var startPagi = (startPagi-paginateLimitValue)+1;
							
							$('#start-pagination-completed').html(startPagi);
						}
						$('#end-pagination-completed').html(((page_com-1)*paginateLimitValue)+data.info.length);
