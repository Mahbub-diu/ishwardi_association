...
@section('content')
    <section class="contact-banner-main"
        style="background: url({{ url('storage/app/public/page-top-configurations/'.$pageTopData['top_banner_image'])}});background-size: cover;background-repeat: no-repeat;background-position: center center;">
        <div class="container">
    ...
    <section class="news-main">
        <div class="container">
            ...
            <div class="row" id="pagination_data">
					...
					@include("front-end.ongoing-project-pagination",["data"=>$data])
