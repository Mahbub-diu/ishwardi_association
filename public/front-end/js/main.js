!(function (e) {
    ...
    e(window).on("scroll", function () {
        ...
        (a = e(".sticky-activee")),
            ...
            e(window).scrollTop() > 800
                ? (a.parent().addClass(o),
                  n > t ? a.removeClass(s) : a.addClass(s))
                : (a.parent().css("min-height", "").removeClass(o),
                  a.removeClass(s)),
            (t = n),
        ...
        e(".as-carousel").each(function () {
            ...
            e("[data-slick-next]").each(function () {
                ...
                t.slick({
                    ...
                    autoplaySpeed: a("autoplay-speed")
                        ? a("autoplay-speed")
                        : 8e3,
                    centerPadding: a("center-padding")
                        ? a("center-padding")
                        : "0",
            ...
            jQuery
                ...
                .done(function (t) {
                    r.removeClass("error"),
                        ...
                        r.text(t),
                        e(
                            n + ' input:not([type="submit"]),' + n + " textarea"
                        ).val("");
                })
                .fail(function (e) {
    ...
    e("[data-sec-pos]").length &&
        ...
        e(".testi-card-tab").length &&
            e(".testi-card-tab").asTab({
                sliderTab: !0,
                tabButton: ".tab-btn",
            }),
        e(".service-block-tab").length &&
            e(".service-block-tab").asTab({
                sliderTab: !0,
                tabButton: ".tab-btn",
            }),
